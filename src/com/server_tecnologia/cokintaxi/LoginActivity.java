...
public class LoginActivity extends Activity {
	...
	private static final String url_login_usuario = "http://www.server-tecnologia.com/cokin_taxi/login_usuario.php";	
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		link_to_register.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				// creating new product in background thread
	            Intent intent = new Intent(getApplicationContext(), IncluirUsuarioActivity.class);
	...
	class LoginUsuario extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			JSONObject json = jsonParser.makeHttpRequest(url_login_usuario,
					"GET", params);
